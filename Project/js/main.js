...
let end = new Date("2023-12-06");


let daysDate = document.querySelector("#days");
...
function timerUpdater() {
  ...
  let elapsedTime = end - currentDate;
  ...
  daysDate.innerHTML = days;
  hoursDate.innerHTML = hours % 24;
  minutesDate.innerHTML = minutes % 60;
  secondsDate.innerHTML = seconds % 60;
}


let timerInterval = setInterval(timerUpdater, 1000);
