...
const names = ['baxtzod', 'xamza', 'islom', 'abdumanon', 'xojik', 'aziz'];

const longestName = names.filter(name => name.length === names.reduce((acc, curr) => acc > curr.length ? acc : curr.length, 0))[0];
